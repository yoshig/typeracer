...
(function() { this.JST || (this.JST = {}); this.JST["chatbox"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["heats/highscores"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="text-info well well-lg">\n  You just wrote a passage ',  race.get("source") ,'.\n</div>\n\n<div class="row">\n\t<div class="col-md-6">\n\t\t');  if (heat_stat.slowpoke) { ; __p.push('\n\t\t\tNice try, but you didn\'t finish in time.\n\t\t');  } else { ; __p.push('\n\t\t\t<table class="current-race-scores table">\n\t\t\t\t<tr>\n\t\t\t\t\t<td>Your speed:</td><td>',  heat_stat.wpm ,' wpm</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td>Time:</td><td>',  heat_stat.time ,'</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td>Accuracy:</td><td>',  heat_stat.wpm_percentile ,'</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t');  } ; __p.push('\n\t</div>\n\n\t<div class="col-md-6">\n\t\t<button class="start-new-game btn btn-info">Race Again?</button>\n\t</div>\n</div>\n\n<div class="row">\n\t<div class="col-md-6">\n\t\t<div class="panel panel-default">\n\t\t\t<div class="highscore-header panel-heading table">\n\t\t\t\t<span class="race-all-time-scores">Fastest Typists |</span>\n\t\t\t\t<span class="race-personal-scores">My Scores</span>\n\t\t\t</div>\n\n\t\t\t<table class="show-scores table">\n\t\t\t\t');  if (list.length !== 0) { ; __p.push('\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<th>#</th><th>User</th><th>Speed</th>\n\t\t\t\t\t</tr>\n\t\t\t\t\t');  list.forEach(function(score, i) { ; __p.push('\n\t\t\t\t\t<tr class="top-user" data-racer="',(''+ score.user_id ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'">\n\t\t\t\t\t\t<td>',  i + 1 ,'</td>\n\t\t\t\t\t\t<td>',(''+ score.username ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</td>\n\t\t\t\t\t\t<td>',  score.wpm_avg ,' wpm</td>\n\t\t\t\t\t');  }) ; __p.push('\n\t\t\t\t');  } else { ; __p.push('\n\t\t\t\t\t<tr>\n\t\t\t\t\tYou have to race more and be signed in to see your top scores!\n\t\t\t\t\t</tr>\n\t\t\t\t');  } ; __p.push('\n\t\t\t</table>\n\t\t</div>\n\t</div>\n</div>\n\n<div class="user-modal"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["heats/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="race-track" class="col-md-12"></div>\n\n<div id="game-board" class="col-md-8 col-md-offset-2"></div>\n<div id="count-down" class="col-md-1 well well-sm">...</div>\n<div id="waiting" class="col-md-12">\n  Waiting for players... (<a href="/#heats/practice">Practice</a>)\n</div> \n\n\n<div id="chat-box" class="12"></div>\n\n<div id="score-board" class="col-md-12"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["heats/share_modal"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal fade" id="share-link" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n  <div class="modal-dialog">\n    <div class="modal-content">\n      <div class="modal-header">\n        <h4 class="modal-title" id="myModalLabel">Share this link with your friends:</h4>\n      </div>\n      <div class="modal-body">\n\t\t\t\thttp://localhost:3000/#heats/',  path ,'\n      </div>\n      <div class="modal-footer">\n        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["heats/track"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n\t<div class="col-md-10 finish_line">\n\t\t<table class="racer"\n\t\t       data-racer-id="',  racer.racer_id ,'">\n\t\t\t<tr>\n\t\t\t\t<td class="racer_name">\n\t\t\t\t\t',(''+ racer.racer_name.slice(0,5) ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'\n\t\t\t\t</td>\n\n\t\t\t\t<td class="racer_car">\n\t\t\t\t\t<img alt="GOGOGO" src="',  racer.racer_img ,'">\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</table>\n\t</div>\n\t<div class="col-md-2">\n\t\t<span class="race_wpm">0 WPM</span>\n\t\t<br>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["racer_stats/user_input"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="form-inline" role="form">\n\t<div class="form-group">\n\t\t<label for="user-input" class="race_text">\n\t\t\t<div id="game-text" class="unselectable">\n\t\t\t\t<span id="current-word">\n\t\t\t\t\t',  words[0] ,'</span>',  " " + words.slice(1).join(" ") ,'\n\t\t\t</div>\n\t\t</label>\n<p>\n\t\t<div class="form-group">\n\t\t\t<input type="text"\n\t\t\t       value=""\n\t\t\t\t\t\t id="user-input"\n\t\t\t\t\t\t class="user-input form-control"\n\t\t\t\t\t\t disabled="disabled"\n\t\t\t\t\t\t placeholder="Get Ready To Type!">\n\t\t </div>\n\t </div>\n\t </p>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["static/splash"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n\n\t<h1 class="splash-heading">TypeDasher<h1>\n\n  <div class="splash-option">\n\t\t<h2 id="sign_in hidden">\n\t\t\t<a class="btn btn-info buttoning" href="/session/new">Sign In</a>\n\t\t</h2>\n\t</div>\n\n  <div class="splash-option">\n\t\t\t<a class="btn btn-info buttoning" href="/session/new">Sign Up</a>\n\t</div>\n\n  <div class="splash-option">\n\t\t<a href="#heats/new_normal" class="btn btn-danger btn-large guest-btn" role="button">\n\t\t\tRace As A Guest\n\t\t</a>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n\t<div class="col-md-6">\n\t\t<div class="all-views-highscore-header panel panel-default">\n\t\t\t<div class="panel-heading table nav nav-tabs">\n\t\t\t\t<span class="user-all-time-wpm record-header">Fastest Typists  | </span>\n\t\t\t\t<span class="user-recent-wpm record-header">Recent Leaders  | </span>\n\t\t\t\t<span class="user-total-races record-header">Total Races</span>\n\t\t\t</div>\n\t\t\t<table class="all-pages-show-scores table">\n\t\t\t\t');  if (list.length !== 0) { ; __p.push('\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\t#\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\tUser\n\t\t\t\t\t\t</th>\n\t\t\t\t\t\t<th>\n\t\t\t\t\t\t\t',  category == "races" ? "Total Races" : "WPM" ,'\n\t\t\t\t\t\t</th>\n\t\t\t\t\t</tr>\n\t\t\t\t\t');  _.each(list, function(racer, i) { ; __p.push('\n\t\t\t\t\t\t<tr class="hof-user" data-racer="',  racer.user_id ,'">\n\t\t\t\t\t\t\t<td>',  i + 1 ,'</td>\n\t\t\t\t\t\t\t<td>',(''+ racer.username ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</td>\n\t\t\t\t\t\t\t<td>',  racer[category] ,'</td>\n\t\t\t\t\t\t</th>\n\t\t\t\t\t');  }) ; __p.push('\n\t\t\t\t');  } else { ; __p.push('\n\t\t\t\t<tr>\n\t\t\t\tNo race data to display.\n\t\t\t\t</tr>\n\t\t\t\t');  } ; __p.push('\n\t\t\t</table>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n\n<div class="user-modal"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/modal"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal fade" id="user-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n  <div class="modal-dialog">\n    <div class="modal-content">\n      <div class="modal-header">\n        <h4 class="modal-title" id="myModalLabel">User Statistics</h4>\n      </div>\n      <div class="modal-body">\n        ');  var userShow = JST["users/show"] ; __p.push('\n\t\t\t\t',  userShow({ user: user }) ,'\n      </div>\n      <div class="modal-footer">\n        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  user.escape("username") ,'</h1>\n<table class="table table-striped">\n\t<tr>\n\t\t<td>Average WPM: </td><td>',  user.escape("wpm_avg") ,'</td>\n\t</tr>\n\t<tr>\n\t\t<td>Best Race: </td><td>',  user.escape("best_race") ,'</td>\n\t</tr>\n\t<tr>\n\t\t<td>Races Completed: </td><td>',  user.escape("total_races") ,'</td>\n\t</tr>\n\t<tr>\n\t\t<td>Skill Level: </td><td>',  user.escape("skill_level") ,'</td>\n\t</tr>\n\t<tr>\n\t\t<td>Joined: </td><td>',  user.escape("start_date") ,'</td>\n\t</tr>\n</table>\n');}return __p.join('');};
}).call(this);
