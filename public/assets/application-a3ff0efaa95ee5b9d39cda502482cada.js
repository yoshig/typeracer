...
window.TypeRacer.Views.Track = Backbone.View.extend({
	...
	setupGameChannel: function(data) {
		...
		if (!this.gameChannel) {
			...
			TypeRacer.pusher.channel.find("game_lobby") &&
